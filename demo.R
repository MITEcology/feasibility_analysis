...
matB <- generate_inte_neg_rand(4, 1, 1, 0, "norm") ## Generate a globally stable random matrix
...
feasibility_partition(matD) ## The feasibility of all the 2^|S| possible combinations

feasibility_species(matC, sp = 2) ## The sum of feasibility regions whith species i
...
feasibility_contribution(matC, sp = 2) ## This is a ratio between the feasibility with |S| species and with |S-1| species. Otcomes above (resp. below) 1 mean a positive (resp. negative) contribution

feasibility_invasion(matC, invader = 1) ## This is the feasibility region for invasion
